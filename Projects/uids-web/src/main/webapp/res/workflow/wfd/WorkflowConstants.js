...
//		['READONLY', '只读']
	...
	ACTIONSET_OUT : ['00A','00B','00C','00D','00E','00F','00G','00P','00R','00S'], //发文动作
	ACTIONSET_IN : ['00A','00B','00D','00F','00E','00R'], //收文动作
	ACTIONSET_AFFAIR : ['00A','00B','00F','00E','00G'], //审批动作
	
	ACTIONSET_START : ['00A','00C','00D','00G'], //开始节点动作
	ACTIONSET_NORMAL : ['00A','00B','00C','00D','00F','00G','00P','00R','00S'], //普通节点动作
...
//		{id : '00C', name : '工作动态'},
	...
	/** 公用链接  */
	RUNNER_URL : '../workflow/workflowTemplate!selectUser.do',
	HANDLER_URL : '../workflow/workflowTemplate!getMainHandler.do',
	DEAL_FIRST_URL : '../workflow/workflowTemplate!dealFirst.do',
	//FORM_LIST_URL : '../form/form-info!getFormInfoListAjax.do?formType='
	FORM_LIST_URL : '../autoform/formAll?',
	ORG_LIST_URL:'../autoform/orgAll?',
	WORK_LOG:'../workflow/workflowTemplate!workflowLog.do?workflowId='
};
