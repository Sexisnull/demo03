...
Ext.extend(Node,Ext.BoxComponent,{
	...
	initImage : function(){
		...
		switch(type){
			case StateMonitor.START_NODE : this.el.dom.style.backgroundImage="url(../res/workflow/images/start.png)";break; 
			case StateMonitor.END_NODE : this.el.dom.style.backgroundImage="url(../res/workflow/images/end.png)";break; 
			case StateMonitor.NODE : {
									if(this.Wrapper.getEditState()==""||this.Wrapper.getEditState()==Workflow.EDITING){
										this.el.dom.style.backgroundImage="url(../res/workflow/images/node.png)";
									}else{
										var state = this.model.getState()
										switch(state){
											case Workflow.ACTIVITY_STATE.BEBACK :
											case Workflow.ACTIVITY_STATE.DOING : this.el.dom.style.backgroundImage="url(../res/workflow/images/doing.png)";break;
											case Workflow.ACTIVITY_STATE.BACK :
											case Workflow.ACTIVITY_STATE.END : this.el.dom.style.backgroundImage="url(../res/workflow/images/finish.png)";break;
											case Workflow.ACTIVITY_STATE.UNSTATRT : 
											default : this.el.dom.style.backgroundImage="url(../res/workflow/images/noNode.png)";
										}
									}
								}
			break; 
...
//					}
			case StateMonitor.NODE : {
					var state = this.model.getState()
					switch(state){
						//case Workflow.ACTIVITY_STATE.UNSTATRT : this.el.dom.style.backgroundImage="url(../res/workflow/images/noNode.png)";break;
						case Workflow.ACTIVITY_STATE.BACK :
						case Workflow.ACTIVITY_STATE.BEBACK :
						case Workflow.ACTIVITY_STATE.DOING : 
						case Workflow.ACTIVITY_STATE.END : html = this.getRealRunner();break; 
	...
	getRunner : function(){
		...
		var deptNames = obj.deptNames ? '【部门】:'+obj.deptNames : '';
...
//					html+="办理期限:"+user.expectTime+"<br>";
				...
				if(user.assignTime == user.expectTime || user.expectTime==null){ //任务到达时间和超期时间相等
					html += "<tr><td width='32'>"+this.getDealStateIcon(user.dealState)+"</td><td align='left' width='180'>"+user.userName+"</td><td align='center' width='70'>"+user.dealTime+"&nbsp;</td></tr>";
				}else{
...
//					var currentTime = nowDate.format("Y-m-d H:i:s");
					...
					html += "<tr><td width='32'>"+this.getDealStateIcon(user.dealState)+"</td><td align='left' width='100'>"+user.userName+"</td><td align='center' width='70'>"+user.dealTime+"&nbsp;</td><td align='center' width='70'>"+expect+"&nbsp;</td></tr>";
				}
			}
	...
	getDealStateIcon : function(state){
		var icon = "";
		switch(state){
			case Workflow.DEAL_STATE.DOING : icon="<img src='../res/workflow/images/emailwrite.gif'/>";  break;
			case Workflow.DEAL_STATE.DONE : icon="<img src='../res/workflow/images/queding.gif'/>"; break;
			case Workflow.DEAL_STATE.WAITING : icon="<img src='../res/workflow/images/emailwrite.gif'/>"; break;
			case Workflow.DEAL_STATE.BACK : icon="<img src='../res/workflow/images/icon_back.gif'/>"; break;
			case Workflow.DEAL_STATE.BEBACK : icon="<img src='../res/workflow/images/icon_re2.gif'/>"; break;
			default : icon="<img src='../res/workflow/images/emailwrite.gif'/>";
		}
		return icon;
	},
	//--END--
