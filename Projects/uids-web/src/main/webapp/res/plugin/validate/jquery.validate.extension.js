...
jQuery.validator.addMethod("isIdCardNo", function(value, element) {
  var idCard = /^((1[1-5])|(2[1-3])|(3[1-7])|(4[1-6])|(5[0-4])|(6[1-5])|71|(8[12])|91)\d{4}((19\d{2}(0[13-9]|1[012])(0[1-9]|[12]\d|30))|(19\d{2}(0[13578]|1[02])31)|(19\d{2}02(0[1-9]|1\d|2[0-8]))|(19([13579][26]|[2468][048]|0[48])0229)|(20[01]\d(0[13-9]|1[012])(0[1-9]|[12]\d|30))|(20[01]\d(0[13578]|1[02])31)|(20[01]\d02(0[1-9]|1\d|2[0-8]))|(2000|2004|2008|2012|2016|2020)0229)\d{3}(\d|X|x)?$/;
  return this.optional(element) || (idCard.test(value));
}, "请输入正确的身份证号码!");

// 收件类型验证
jQuery.validator.addMethod("isopersign", function(value, element) {
	return this.optional(element) || (/^1$/.test(value));
}, "请收取必要性材料");
// 类型验证不为0
jQuery.validator.addMethod("plselect", function(value, element) {
...
jQuery.validator.addMethod("isPhone", function(value, element) {
  var tel = /^((0[0-9]{2,3}\-)?([2-9][0-9]{6,7})+(\-[0-9]{1,4})?)|(((\(\d{3}\))|(\d{3}\-))?(1[34578]\d{9}))$/g;
...
jQuery.validator.addMethod("isTel", function(value,element) {
    var length = value.length;
    var mobile = /^(((13[0-9]{1})|(14[0-9]{1})|(15[0-9]{1})|(17[0-9]{1})|(18[0-3,5-9]{1}))+\d{8})$/;
...
jQuery.validator.addMethod("isAmount", function(value, element) {
	var tel = /^([1-9][\d]{0,7}|0)(\.[\d]{1,2})?$/;
	return this.optional(element) || (tel.test(value));
}, "金额格式错误(0.00-99999999.99)");
