	...
	<div class="top">
	  <div class="nav">
		  ...
		  <div class="hyzx">
			...
			<span title="个人信息"><a href="modifyperinfo_show"><img  src="${ctx}/ui/images/vip_head.png" width="23" height="23"></a></span>
			<!--  <span title="实名认证"><a href="register/perauth_show"><img  src="./images/vip_head.png" width="23" height="23"></a></span>-->
			<span title="注销"><a href="perlogout"><img src="${ctx}/ui/images/logout.png" width="22" height="24"></a></span>
		  </div>    	
	  </div>   
	</div>
