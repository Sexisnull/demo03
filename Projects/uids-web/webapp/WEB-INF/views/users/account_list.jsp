        ...
        <table cellpadding="0" cellspacing="0" border="0" width="100%" class="list-table">
        	<thead>
            	<tr>
                    ...
                    <th width="10%" class="alignL" style="text-align: center;">所属机构</th>
                    <th width="15%" class="alignL" style="text-align: center;">用户职务</th>
                    <th width="5%" style="text-align: center;">办公电话</th>
                    <th width="30%" style="text-align: center;">账号开启</th>
                </tr>
            </thead> 
            <tbody>
                <c:forEach items="${pageInfo.content}" var="sysAccount" varStatus="state">
					<tr class="myclass">
	                    ...
	                    <td style="text-align: center;">
	                    	<div title="${userRolemap[complatUser.groupid]}" class="word_break">${userRolemap[complatUser.groupid]}</div>
	                    </td>
	                    <td style="text-align: center;">
	                	...
	                	<td class="alignL" style="text-align: center;">
	                    	${complatUser.createtime}
	                    </td>
	                	<td style="text-align: center;">
	                    	<div class="alignL">
	                    		<div class="list-longtext">
	                    			<c:if test="${complatUser.enable == '0'}"><font color="red">停用</font></c:if>
