	...
	<body>
		...
		<div class="ui-layout-north">
			...
			<div style="width:78%; height:500px; float:left;">
				<iframe id="main1" src="${ctx}/application/applicationList" class="ui-layout-center" frameborder="0" height="100%" width="100%" name="iframe" scrolling="yes">
