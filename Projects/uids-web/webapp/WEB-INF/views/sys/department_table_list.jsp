    ...
    rules: {
	   ...
	   xzqh: {
	    ...
	    maxlength: 12
            ...
            if(deptId==''){
            	$.validator.errorShow($("#deptName"),'添加部门请从左侧树添加，此处只用于编辑');
            	return false;   
            }else{
				 form.submit();
			}
...
var setting1 = {
		async: {
				enable: true,
				url: "${ctx}/sys/departmenttree" //获取节点数据的URL地址
			},
			view: {
...
<script type="text/javascript" src="${ctx}/res/js/region/region.js"></script>
<style>
...
/**闁跨喐鏋婚幏鐑芥晸閺傘倖瀚归柨鐔告灮閹风??闁跨喐鏋婚幏鐑芥晸閺傘倖瀚�*/
...
/**闁跨喐鏋婚幏鐑芥晸閿熶粙鏁撻弬銈嗗??闁跨喐鏋婚幏鐑芥晸閺傘倖瀚�*/
...
<div class="form-warper" style="overflow:hidden">
    ...
    <div style="display:none;">
    	<input type="hidden" id="deptId" name="deptId" value="${sysDept.deptId}"/>
    	<input type="hidden" id="state" name="state" value="${sysDept.state}"/>	
    	<input type="hidden" id="createTime" name="createTime" value="${sysDept.createTime}"/>	
    	<input type="hidden" id="userAcctId" name="userAcctId" value="${sysDept.userAcctId}"/>	
    	<input type="hidden" id="setId" name="setId" value="${sysDept.setId}"/>
    </div>
    ...
    <div class="form-content double fn-left">
        <ul class="form-table">
        	<!--,nameCheck: true,isUnique:true,cnRangelength:[1,64] -->
        	 <li>部门名称</li>
            <li>
            	<input type="text" style="background:#F0F0F0;" disabled="disabled" class="input" id="regionName1" name="deptName1" value="${sysDept.deptName}"  />
            	 <input type="hidden" class="input" id="regionName" name="deptName" value="${sysDept.deptName}"  />
            	<input type="hidden" id="oldDeptName" name="oldDeptName" value="${sysDept.deptName}"  />
            	<i class="form-icon-clear"></i>
            </li>
																
            <li>部门编码</li>
            <li>
            	<input type="text" style="background:#F0F0F0;" disabled="disabled" class="input regionCode" id="regionCode1" name="deptCode1" value="${sysDept.deptCode}" />
            	<input type="hidden" class="input regionCode" id="regionCode" name="deptCode" value="${sysDept.deptCode}" />
            	<i class="form-icon-clear"></i>
            </li> 
            <li><b class="mustbe">*</b>部门排序</li>
            <li>
            	<input type="text" class="input deptSeq"id="deptSeq"  name="deptSeq" value="${sysDept.deptSeq}" />
            	<i class="form-icon-clear"></i>
            </li> 
            <li>上级部门</li>
            <li>
            	<input disabled="disabled" style="background:#F0F0F0;" type="text" class="input parentDeptName" id="parentDeptName" name="parentDeptName" value="${sysDept.parentDepartment.deptName}" />
            	<i class="form-icon-clear"></i>
            	<input type="hidden" id="parentDeptCode" name="parentDeptCode"  value="${sysDept.parentDeptCode}"/>
            </li>
         </ul>
