...
DEFFLD = {
	...
	text : {
		...
		json : '({alias:"单行文本",type:"text",dataLen:"m",NOTNULL:"0",VALID:"",DATAFIELD:"",NAME:"",PARAM:"",BASETABLE:"",BASEFIELD:""})',
	...
	number : {
		...
		json : '({alias:"数字框",type:"number",dataLen:"s",NOTNULL:"0",DATAFIELD:"",NAME:"",PARAM:""})',
		holder : '<li class="field prefocus" style="height:43px;width:97%"></li>'
	},
	textarea : {
		...
		json : '({alias:"多行文本",type:"textarea",dataLen:"m",NOTNULL:"0",MIN:"",DATAFIELD:"",NAME:"",PARAM:"",BASETABLE:"",BASEFIELD:"",MAX:"",DEF:"",INSTR:"",CSS:""})',
	...
	checkbox : {
		...
		json : '({alias:"复选框",type:"checkbox",LAY:"one",NOTNULL:"0",SCU:"pub",DATAFIELD:"",NAME:"",PARAM:"",BASETABLE:"",BASEFIELD:"",INSTR:"",CSS:"",ITMS:[{VAL:"选项 1",CHKED:"0"},{VAL:"选项 2",CHKED:"0"},{VAL:"选项 3",CHKED:"0"}]})',
		holder : '<li class="field prefocus" style="height:92px;width:97%"></li>'
	},
	radio : {
		html : '<label class="desc"><span class="req hide"> *</span></label><div class="content"></div>',
		json : '({alias:"单选框",type:"radio",LAY:"one",NOTNULL:"0",OTHER:"0",DATAFIELD:"",NAME:"",PARAM:"",BASETABLE:"",BASEFIELD:"",RDM:"0",SCU:"pub",INSTR:"",CSS:"",ITMS:[{VAL:"选项 1",CHKED:"0"},{VAL:"选项 2",CHKED:"0"},{VAL:"选项 3",CHKED:"0"}]})',
		holder : '<li class="field prefocus" style="height:92px;width:97%"></li>'
	},
	dropdown : {
		html : '<label class="desc"><span class="req hide"> *</span></label><div class="content"><select disabled="disabled" class="m input"></select></div>',
		json : '({alias:"下拉框",type:"dropdown",dataLen:"m",NOTNULL:"0",DATAFIELD:"",NAME:"",PARAM:"",BASETABLE:"",BASEFIELD:"",SCU:"pub",INSTR:"",CSS:"",ITMS:[{VAL:"选项 1",CHKED:"0"},{VAL:"选项 2",CHKED:"0"},{VAL:"选项 3",CHKED:"0"}]})',
	...
	dropdown2 : {
		...
		json : '({alias:"两级下拉框",type:"dropdown2",dataLen:"m",DATAFIELD:"",NAME:"",PARAM:"",BASETABLE:"",BASEFIELD:"",NOTNULL:"0",SCU:"pub",INSTR:"",CSS:"",SUBFLDS:{DD1:{},DD2:{}},ITMS:[{VAL:"选项 1",CHKED:"0",ITMS:[{VAL:"选项 11"},{VAL:"选项 12"},{VAL:"选项 13"}]},{VAL:"选项 2",CHKED:"0",ITMS:[{VAL:"选项 21"},{VAL:"选项 22"},{VAL:"选项 23"}]},{VAL:"选项 3",CHKED:"0",ITMS:[{VAL:"选项 31"},{VAL:"选项 32"},{VAL:"选项 33"}]}]})',
		holder : '<li class="field prefocus" style="height:46px;width:97%"></li>'
	},
	section : {
		html : '<div class="noLabelAlign"><label class="desc section">分隔符</label><div class="content">这里是分隔符说明</div></div>',
		json : '({alias:"分隔符",type:"section",SCU:"pub",SECDESC:"这里是分隔符说明",CSS:""})',
	...
	html : {
		...
		json : '({alias:"HTML标题",type:"html",SCU:"pub",HTML:"<p>这里可以显示HTML内容</p>",CSS:""})',
	...
	date : {
		...
		json : '({alias:"日期",type:"date",NOTNULL:"0",DATAFIELD:"",NAME:"",PARAM:"",BASETABLE:"",BASEFIELD:"",FMT:"ymd",DEF:"",INSTR:"",CSS:""})',
	...
	time : {
		...
		json : '({alias:"时间",type:"time",NOTNULL:"0",DATAFIELD:"",NAME:"",PARAM:"",BASETABLE:"",BASEFIELD:"",DEF:"",INSTR:"",CSS:""})',
		holder : '<li class="field prefocus" style="height:57px;width:97%"></li>'
	},
	file : {
		...
		json : '({alias:"上传文件",type:"file",dataLen:"m",DATAFIELD:"",NAME:"",PARAM:"",BASETABLE:"",BASEFIELD:"",NOTNULL:"0",INSTR:"",CSS:"",SUBFLDS:{ID:{},TYP:{},SZ:{},NM:{}}})',
	...
	phone : {
		...
		json : '({alias:"电话",type:"phone",NOTNULL:"0",DATAFIELD:"",NAME:"",PARAM:"",BASETABLE:"",BASEFIELD:"",FMT:"mobile",DEF:"",INSTR:"",CSS:""})',
		holder : '<li class="field prefocus" style="height:43px;width:97%"></li>'
	},
	...
	url : {
		...
		json : '({alias:"网址",type:"url",dataLen:"xxl",DATAFIELD:"",NAME:"",PARAM:"",BASETABLE:"",BASEFIELD:"",NOTNULL:"0",DEF:"",INSTR:"",CSS:""})',
		holder : '<li class="field prefocus" style="height:43px;width:97%"></li>'
	},
	money : {
		...
		json : '({alias:"价格",type:"money",NOTNULL:"0",DATAFIELD:"",NAME:"",PARAM:"",BASETABLE:"",BASEFIELD:"",FMT:"yen",DEF:"",INSTR:"",CSS:""})',
		holder : '<li class="field prefocus" style="height:43px;width:97%"></li>'
	},
	email : {
		...
		json : '({alias:"Email",type:"email",dataLen:"m",DATAFIELD:"",NAME:"",PARAM:"",BASETABLE:"",BASEFIELD:"",NOTNULL:"0",DEF:"",INSTR:"",CSS:""})',
	...
	name : {
		...
		json : '({alias:"姓名",type:"name",NOTNULL:"0",DATAFIELD:"",NAME:"",PARAM:"",BASETABLE:"",BASEFIELD:"",FMT:"short",DEF:"",INSTR:"",CSS:""})',
		holder : '<li class="field prefocus" style="height:43px;width:97%"></li>'
	},
	...
	address : {
		...
		json : '({alias:"地址",type:"address",NOTNULL:"0",DATAFIELD:"",NAME:"",PARAM:"",BASETABLE:"",BASEFIELD:"",SCU:"pub",INSTR:"",CSS:"",SUBFLDS:{ZIP:{},PRV:{},CITY:{},DTL:{}}})',
	...
	likert : {
		...
		json : '({alias:"组合单选框",type:"likert",DATAFIELD:"",NAME:"",PARAM:"",BASETABLE:"",BASEFIELD:"",NOTNULL:"0",HDNM:"0",SCU:"pub",CSS:"",ITMS:[{alias:"行标签 1",ITMS:[{VAL:"列标签 1",CHKED:"0"},{VAL:"列标签 2",CHKED:"0"},{VAL:"列标签 3",CHKED:"0"},{VAL:"列标签 4",CHKED:"0"}]},         {alias:"行标签 2",ITMS:[{VAL:"列标签 1",CHKED:"0"},{VAL:"列标签 2",CHKED:"0"},{VAL:"列标签 3",CHKED:"0"},{VAL:"列标签 4",CHKED:"0"}]},         {alias:"行标签 3",ITMS:[{VAL:"列标签 1",CHKED:"0"},{VAL:"列标签 2",CHKED:"0"},{VAL:"列标签 3",CHKED:"0"},{VAL:"列标签 4",CHKED:"0"}]}]})',
...
//		F[IDX].MATFLD = $(this).val();
	...
	var v = function(R) {
		...
		$.each(F, function(T, S) {
			if (M.INSTR === "1" && S.type !== "likert" && S.type !== "html"
