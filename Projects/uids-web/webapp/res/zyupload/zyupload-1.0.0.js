...
//					edit             : true,  						      // 是否可以编辑文件（裁剪）
			...
			this.createHtml = function(){
				...
				if(para.dragDrop){
		            ...
		            html += '				<div id="status_info"  style="margin-left: -41px;" class="info">选中0张文件，共0B。(最多只能选择10张)</div>';
		            html += '				<div class="btns">';
		            ...
		            html += '			<div class="status_bar">';
		            html += '				<div id="status_info" style="" class="info">选中0张文件，共0B。</div>';
		            html += '				<div class="btns">';
		            html += '					<input id="fileImage" type="file" size="30" name="fileselect[]" '+multiple+'>';
		            html += '					<a id="rapidAddImg" class="add_imgBox btns1">';
				    html += '						点击添加文件'; 
				    html += '					</a>';
		            /*html += '					<div class="add_imgBox " id="rapidAddImg">选择文件</div>';*/
		            /*html += '					<div class="upload_btn">开始上传</div>';*/
		            html += '				</div>';
		            html += '			</div>';
			...
			this.funSetStatusInfo = function(files){
				...
				// 设置内容
				$("#status_info").html("选中"+num+"张文件，共"+size+"。(最多只能选择10张)");
			};
