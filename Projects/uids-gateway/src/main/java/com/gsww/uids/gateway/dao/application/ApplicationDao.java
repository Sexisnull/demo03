...
public class ApplicationDao extends JdbcTemplateDao {
	...
	// 查询实时同步列表sql
	private static final String FIND_APP_SQL = "SELECT * FROM JIS_APPLICATION WHERE MARK =?";
	...
	public Application getApplicatioonByMark(String mark) {
		List<Application> list = (List<Application>) ConvertSqlToDtoList.ExeSQL2List(jdbcTemplate, FIND_APP_SQL,
